...
module.exports = function () {
  ...
  function Grammar(grammar) {
    var phonemes = new GrammarPhonemes(grammar.phonemes)
      , transformations = new GrammarTransformations(grammar.transformations, phonemes)
    //  , paradigms = new GrammarParadigms(grammar.paradigms, transformations)

    this.paradigms = new GrammarParadigms(grammar.paradigms, transformations)
