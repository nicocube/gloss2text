...
module.exports = (function () {
  ...
  Pattern.prototype.search = function(a) {
    if (a.length === 0) {
      ...
      if (typeof p === 'string') r.chain(this.parse(p))
      return r
    }
  }
  ...
  Selector.prototype.apply = function(f) {
    ...
    else if (typeof this.p !== 'undefined') r = f[this.p]
    ...
    if (this.r) {
      ...
      if (!x.r) {
        ...
        r = this.pattern.compose.reduce(function(p, c) {
