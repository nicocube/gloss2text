...
module.exports = (function () {
  ...
  var transformRx = /^(?:(\+|-)?([a-zA-Z<>]*)(\+|-)?>)?(\+|-)?([a-zA-Z<>0-9\(\)-]+)(\+|-)?$/
    ...
    , idx_replacement_prefix = 4
    , idx_replacement = 5
    , idx_replacement_suffix = 6
  ...
  GrammarTransformations.prototype.parseRule = function(d) {
    ...
    if (m !== null) {
      ...
      var rule
        ...
        , pfxReplt = typeof m[idx_replacement_prefix] !== 'undefined' && m[idx_replacement_prefix] === '+'
                  || typeof m[idx_replacement_suffix] !== 'undefined' && m[idx_replacement_suffix] === '-'
