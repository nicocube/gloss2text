...
*/
  ...
  function parse_compound(x, w) {
    ...
    return rec_parse_regular(x, w, 0, r, a)
  }
  ...
  function find_paradigm(x) {
    var p = Object.keys(x).filter(function(x) { return x!=='irregular' && x!=='invariant' && x!=='compound'}).reduce(function(p, c) { return p || c }, undefined)
